 ...
 *
 * Driver for Everlight PM-16d17 photometric sensor
 *
...
static int pm16d17_write_raw(struct iio_dev *indio_dev,
			     struct iio_chan_spec const *chan,
			     int val, int val2, long mask)
{
	return 0;
...
static int pm16d17_write_raw_get_fmt(struct iio_dev *indio_dev,
				     struct iio_chan_spec const *chan,
				     long mask)
{
	return 0;
...
static const struct iio_info pm16d17_info = {
	...
	.write_raw = pm16d17_write_raw,
	.write_raw_get_fmt = pm16d17_write_raw_get_fmt,
};
...
static int pm16d17_chip_init(struct pm16d17_data *data)
{
	...
	/* TBD: what if ps-itime is not in dtb, this should return null */
	...
	/* TBD: what if ps-wtime is not in dtb, this should return null */
...
MODULE_DESCRIPTION("PM16D17 photometric sensor");
MODULE_LICENSE("GPL");
